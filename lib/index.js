                            ...
                            load(`${languages}?access_token=${token}`, result => {
                                ...
                                switch (process.platform) {
                                    ...
                                    case 'linux':
                                        ...
                                        load(`https://api.github.com/repos/${repoName}/git/trees/${branch}?recursive=1&access_token=${token}`, ({tree}) => {
                                            /**
                                             * files path
                                             * @type {string[]}
                                             */
                                            ...
                                            Promise.all(repoLanguages.map(lang => Promise.all(files
                                                ...
                                                .map(path => new Promise(resolve => {
                                                    ...
                                                    exec(`svn --non-interactive --trust-server-cert cat "${svn}/trunk/${path}"`, {
                                                        encoding: 'utf8',
